...
import edit from '../../styles/Princess.module.css'
import classes from '../../components/PrincessForm.module.css'
...
function PrincessName(p) {
    ...
    return (
        <section className={edit['edit-container']}>
            <aside className={edit['edit-princess']}>
                ...
                <Formik
                        ...
                        try {
                            const graphqlresponse = await fetch(
                                ...
                                'http://localhost:4000/',
                                {
                                    ...
                                    method: 'POST',
                                    body: JSON.stringify({
                                        query: `mutation EdditBrincess($brincess: BrincessInput!) {
                                    edditBrincess(brincess: $brincess) {name}
                                  }`,
                                        variables: {
                                            brincess: {
                                                name: values.name,
                    ...
                    validate={(values) => {
                        ...
                        if (values.name.length > 10) {
                            errors.name =
                                'Name must contain maximux of 10 letters'
                        }
            ...
            <section className={edit['princess-section']}>
                <h1>
                    (param → ) {p.params.princessName} (brincess → ){' '}
                    {brincess?.name}
                </h1>
                <section className={edit.main}>
                    <div className={edit['princesses-container']}>
